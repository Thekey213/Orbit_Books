...
import za.ac.iie.opsc7311.orbit_books.AdminBooks
import za.ac.iie.opsc7311.orbit_books.CategoryAdapter
                ...
                if (snapshot.exists()){
                    ...
                    adapter.setItemClickListener(object : CategoryAdapter.OnItemClickListener{
                        override fun onItemClick(position: Int) {
                            ...
                            startActivity(intent)
                            Toast.makeText(this@Category,"Books page for admin $position", Toast.LENGTH_SHORT).show()
